...
namespace SanGiuseppe.Migrations
{
    ...
    [Migration("20210712144121_AvvisiAnnoObbligatorio")]
    partial class AvvisiAnnoObbligatorio
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AvvisiPermessiUtentiPermessi", b =>
                {
                    b.Property<int>("AvvisiPermessiIdAvvisPermesso")
                        .HasColumnType("int");

                    b.Property<int>("UtentiPermessiIdUtentePermesso")
                        .HasColumnType("int");

                    b.HasKey("AvvisiPermessiIdAvvisPermesso", "UtentiPermessiIdUtentePermesso");

                    b.HasIndex("UtentiPermessiIdUtentePermesso");

                    b.ToTable("AvvisiPermessiUtentiPermessi");
                });
            ...
            modelBuilder.Entity("AvvisiPermessiUtentiPermessi", b =>
                {
                    b.HasOne("SanGiuseppe.Models.AvvisiPermessi", null)
                        .WithMany()
                        .HasForeignKey("AvvisiPermessiIdAvvisPermesso")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SanGiuseppe.Models.UtentiPermessi", null)
                        .WithMany()
                        .HasForeignKey("UtentiPermessiIdUtentePermesso")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
